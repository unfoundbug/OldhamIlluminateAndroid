...
JNIEXPORT void JNICALL Java_com_badlogic_gdx_audio_analysis_KissFFT_spectrum(JNIEnv* env, jclass clazz, jlong handle, jshortArray obj_samples, jfloatArray obj_spectrum) {
	short* samples = (short*)env->GetShortArrayElements(obj_samples, 0);
	float* spectrum = (float*)env->GetFloatArrayElements(obj_spectrum, 0);
...
//@line:109
	...
	env->ReleaseShortArrayElements(obj_samples, samples, 0);
	env->ReleaseFloatArrayElements(obj_spectrum, spectrum, 0);
